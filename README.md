...
- 🧩 Active DSA practitioner — see `Complete_DSA_Problems`

---

### 🔬 Research Publication

**Deep Learning–Enhanced Breast MRI for AI-Driven Diagnosis of Breast Cancer: A Review and Analytical Study**  
*Lead Author · IJRDET · ISSN 2347-6435 · Vol. 15, Issue 05 · May 2026*

> Reviewed 40+ studies on CNN, U-Net & transformer architectures for MRI-based breast cancer detection. Proposed a hybrid framework integrating DCE-MRI, DWI & T2 sequences with Grad-CAM explainability and multimodal clinical data fusion.
